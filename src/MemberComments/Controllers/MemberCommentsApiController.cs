...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "MemberComments")]
    public class MemberCommentsApiController : MemberCommentsApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public MemberCommentsApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
