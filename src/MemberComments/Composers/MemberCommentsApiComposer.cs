...
{
    public class MemberCommentsApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Member Comments Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<MemberCommentsOperationSecurityFilter>();
            });
        }

        public class MemberCommentsOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("MemberComments.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
